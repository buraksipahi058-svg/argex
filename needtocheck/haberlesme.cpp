...
//  USART3 varsayilan: TX=PB10, RX=PB11. Diger pinlerle cakisma yok
//  (CRSF=PA9/PA10, motorlar=PA0..PA3/PB8/PB9, servo=PB0/PB1, ates=PA4).
// ============================================================
#define JETSON_TX_PIN   PB10
#define JETSON_RX_PIN   PB11
